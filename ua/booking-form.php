        ...
        <form class="booking-form" name="bookroom" action="#" method="post">
            ...
            <div class="select-wrapper">
                <select id="room" name="book_room_type_and_price">
                    <option value="none">Виберіть кімнату</option>
            ...
            <div class="calendar">
                <input type="text" id="date_from" class="datepicker input" name="date_from" placeholder="Заїзд">
                <input type="text" id="date_to" class="datepicker input" name="date_to" placeholder="Виїзд">
                <input type="text" id="number" class="number input" name="number" placeholder="Телефон">
            </div>

            <input type="hidden" name="book_confirm" value="1">
            <input class="bookbutton" type="submit" value="Забронювати">
